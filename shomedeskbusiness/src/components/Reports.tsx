    ...
    try {
      ...
      if (isAllBusinessesSelected) {
        ...
        for (const chunk of chunks) {
          let q = query(collection(db, reportType), where('businessId', 'in', chunk));
        ...
        let q = query(collection(db, reportType), where('businessId', '==', selectedBusiness!.id));
      ...
      handleFirestoreError(error, OperationType.GET, reportType);
